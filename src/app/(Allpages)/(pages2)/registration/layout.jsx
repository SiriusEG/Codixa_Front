...
const layout = ({ children }) => {
  return (
    <div className="  flex flex-col items-center justify-center  mt-0 bg-white sm:bg-transparent px-4 py-3 sm:p-1 z-10 sm:z-0 rounded-3xl sm:rounded-none ">
      {/* upper area  */}
      <div className=" relative flex w-full sm:w-96 flex-col items-center justify-center gap-6">
        ...
        <Link
          href="/"
          type="button"
          className="flex absolute left-4 sm:left-[-6rem] md:left-[-6rem] top-[-5rem] items-center gap-2 self-start mx-4 text-base font-medium transition duration-300 hover:text-primary hover:bg-primary/25 py-2 px-4 rounded-2xl"
        >
          <FaArrowLeft />
          Back To Home
        </Link>
