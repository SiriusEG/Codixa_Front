  ...
  return (
    <div className="flex justify-center items-center  mt-8 space-x-4">
      <button
        ...
        className="px-4 py-2 mr-2 bg-primary text-white rounded-lg disabled:opacity-50 hover:bg-primary-dark transition-colors"
      >
        Previous
      </button>
      <p className="px-8 contents py-2 text-gray-700">
