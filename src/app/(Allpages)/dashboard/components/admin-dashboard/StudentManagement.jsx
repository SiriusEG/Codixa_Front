...
const STUDENTS_API = "https://codixa.runasp.net/api/admin/GetAllStudents";
const UPDATE_API = "https://codixa.runasp.net/api/admin/ChangeStudentData";
                  ...
                  {s.profilePic ? (
                    ...
                    <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center">
                      <span className="text-gray-600 text-lg font-medium">
                        {s.studentFullName?.charAt(0)?.toUpperCase() || "?"}
                      </span>
                    </div>
                  )}
                </td>
                <td className="px-4 py-2">{s.studentFullName}</td>
          ...
          <div className="bg-white p-8 rounded shadow-lg w-full max-w-lg">
            ...
            >
              <input
                ...
                value={editData.studentFullName || ""}
